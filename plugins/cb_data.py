...
from helper.database import find, find_one, used_limit
...
async def start(bot, update):
    await update.reply_text("Welcome! Send me a file and I'll process it.")
...
async def handle_document(bot, update):
    # Assuming 'handle_document' should process the received document
    pass
...
async def vid(bot, update):
    ...
    if value < file.file_size:
        ...
        try:
            filw = await bot.send_video(log_channel, video=file_path, thumb=ph_path, duration=duration, caption=caption, progress=progress_for_pyrogram, progress_args=("`Tʀyɪɴɢ Tᴏ Uᴘʟᴏᴀᴅɪɴɢ....`", ms, c_time))
